...
namespace Kodlama.io.Application.Services.AuthService
{
    public class AuthManager : IAuthService
    {
        ...
        {
           var oldRefreshtokens =  await _refreshTokenRepository.GetListAsync(c => c.UserId == user.Id);
            foreach (var refreshToken in oldRefreshtokens.Items)
